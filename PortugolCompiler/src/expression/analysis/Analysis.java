...
public interface Analysis extends Switch
{
    ...
    void caseAIgualdadeSinalIgualgade(AIgualdadeSinalIgualgade node);
    void caseADiferencaSinalIgualgade(ADiferencaSinalIgualgade node);
    ...
    void caseATermoRelacionalFatorLogico(ATermoRelacionalFatorLogico node);
    void caseATermoRelacionalTermoRelacional(ATermoRelacionalTermoRelacional node);
    void caseAFatorRelacionalTermoRelacional(AFatorRelacionalTermoRelacional node);
    void caseAFatorRelacionalFatorRelacional(AFatorRelacionalFatorRelacional node);
    void caseATermoAritmeticoFatorRelacional(ATermoAritmeticoFatorRelacional node);
    void caseATermoAritmeticoTermoAritmetico(ATermoAritmeticoTermoAritmetico node);
    void caseAFatorAritmeticoTermoAritmetico(AFatorAritmeticoTermoAritmetico node);
    void caseAFatorAritmeticoFatorAritmetico(AFatorAritmeticoFatorAritmetico node);
    void caseATermoAritmeticoFatorAritmetico(ATermoAritmeticoFatorAritmetico node);
