...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTACochete(@SuppressWarnings("unused") TACochete node)
    {
        this.index = 7;
    }

    @Override
    public void caseTFCochete(@SuppressWarnings("unused") TFCochete node)
    {
        this.index = 8;
    }

    @Override
    public void caseTAParenteses(@SuppressWarnings("unused") TAParenteses node)
    {
        this.index = 9;
    }

    @Override
    public void caseTFParenteses(@SuppressWarnings("unused") TFParenteses node)
    {
        this.index = 10;
    }
    ...
    @Override
    public void caseTProximo(@SuppressWarnings("unused") TProximo node)
    {
        this.index = 33;
    }
    ...
    @Override
    public void caseTEscrevaln(@SuppressWarnings("unused") TEscrevaln node)
    {
        this.index = 36;
    }
    ...
    @Override
    public void caseTNCaractere(@SuppressWarnings("unused") TNCaractere node)
    {
        this.index = 58;
    }
