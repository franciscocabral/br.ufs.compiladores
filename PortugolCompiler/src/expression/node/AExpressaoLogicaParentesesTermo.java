...
public final class AExpressaoLogicaParentesesTermo extends PParentesesTermo
{
    private PExpressaoLogica _expressaoLogica_;

    public AExpressaoLogicaParentesesTermo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressaoLogicaParentesesTermo(
    ...
    {
        ((Analysis) sw).caseAExpressaoLogicaParentesesTermo(this);
    }
