...
public final class AMaiorSinalRelacional extends PSinalRelacional
{
    private TMaior _maior_;

    public AMaiorSinalRelacional()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorSinalRelacional(
    ...
    {
        ((Analysis) sw).caseAMaiorSinalRelacional(this);
    }
