...
public final class AMenosExpressaoExpressao extends PExpressao
{
    private TMenos _menos_;
    private PExpressao _expressao_;

    public AMenosExpressaoExpressao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenosExpressaoExpressao(
    ...
    {
        ((Analysis) sw).caseAMenosExpressaoExpressao(this);
    }
