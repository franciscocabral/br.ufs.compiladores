...
public final class AMaiorIgualSinalRelacional extends PSinalRelacional
{
    private TMaiorigual _maiorigual_;

    public AMaiorIgualSinalRelacional()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorIgualSinalRelacional(
    ...
    {
        ((Analysis) sw).caseAMaiorIgualSinalRelacional(this);
    }
