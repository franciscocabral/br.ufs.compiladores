...
public final class AVariavelExpressaoLogica extends PExpressaoLogica
{
    private PVariavel _variavel_;

    public AVariavelExpressaoLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVariavelExpressaoLogica(
    ...
    {
        ((Analysis) sw).caseAVariavelExpressaoLogica(this);
    }
