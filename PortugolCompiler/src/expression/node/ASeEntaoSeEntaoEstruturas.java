...
public final class ASeEntaoSeEntaoEstruturas extends PSeEntaoEstruturas
{
    private TSe _se_;
    ...
    public ASeEntaoSeEntaoEstruturas()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASeEntaoSeEntaoEstruturas(
            cloneNode(this._se_),
    ...
    {
        ((Analysis) sw).caseASeEntaoSeEntaoEstruturas(this);
    }
