...
public final class ARestoExpressaoLogica extends PExpressaoLogica
{
    private PExpressaoLogica _l_;
    private PExpressaoLogica _r_;

    public ARestoExpressaoLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARestoExpressaoLogica(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseARestoExpressaoLogica(this);
    }
