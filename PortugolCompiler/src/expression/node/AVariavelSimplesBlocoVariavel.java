...
public final class AVariavelSimplesBlocoVariavel extends PBlocoVariavel
{
    private PVariavel _variavel_;

    public AVariavelSimplesBlocoVariavel()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVariavelSimplesBlocoVariavel(
    ...
    {
        ((Analysis) sw).caseAVariavelSimplesBlocoVariavel(this);
    }
