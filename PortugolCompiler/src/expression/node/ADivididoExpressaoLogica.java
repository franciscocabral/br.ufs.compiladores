...
public final class ADivididoExpressaoLogica extends PExpressaoLogica
{
    private PExpressaoLogica _l_;
    private PExpressaoLogica _r_;

    public ADivididoExpressaoLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADivididoExpressaoLogica(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseADivididoExpressaoLogica(this);
    }
