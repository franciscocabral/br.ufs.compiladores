...
public final class ADiferencaSinalIgualgade extends PSinalIgualgade
{
    private TDiferente _diferente_;

    public ADiferencaSinalIgualgade()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADiferencaSinalIgualgade(
    ...
    {
        ((Analysis) sw).caseADiferencaSinalIgualgade(this);
    }
