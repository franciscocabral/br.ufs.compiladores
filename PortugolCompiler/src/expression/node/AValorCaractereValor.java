...
public final class AValorCaractereValor extends PValor
{
    private TCaractere _caractere_;

    public AValorCaractereValor()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AValorCaractereValor(
    ...
    {
        ((Analysis) sw).caseAValorCaractereValor(this);
    }
