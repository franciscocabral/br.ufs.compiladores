...
public final class AParaPassoEstruturas extends PParaPassoEstruturas
{
    ...
    public Object clone()
    {
        return new AParaPassoEstruturas(
    ...
    {
        ((Analysis) sw).caseAParaPassoEstruturas(this);
    }
