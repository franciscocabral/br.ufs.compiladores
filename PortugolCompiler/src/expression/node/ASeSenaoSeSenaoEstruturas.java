...
public final class ASeSenaoSeSenaoEstruturas extends PSeSenaoEstruturas
{
    private TSe _se_;
    ...
    public ASeSenaoSeSenaoEstruturas()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASeSenaoSeSenaoEstruturas(
            cloneNode(this._se_),
    ...
    {
        ((Analysis) sw).caseASeSenaoSeSenaoEstruturas(this);
    }
