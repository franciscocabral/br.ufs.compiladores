...
public final class AMenosExpressaoLogica extends PExpressaoLogica
{
    private PExpressaoLogica _l_;
    private PExpressaoLogica _r_;

    public AMenosExpressaoLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenosExpressaoLogica(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseAMenosExpressaoLogica(this);
    }
