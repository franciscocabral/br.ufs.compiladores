...
public final class AVezesExpressaoLogica extends PExpressaoLogica
{
    private PExpressaoLogica _l_;
    private PExpressaoLogica _r_;

    public AVezesExpressaoLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVezesExpressaoLogica(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseAVezesExpressaoLogica(this);
    }
