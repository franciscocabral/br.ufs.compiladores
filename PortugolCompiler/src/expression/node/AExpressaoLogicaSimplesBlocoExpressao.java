...
public final class AExpressaoLogicaSimplesBlocoExpressao extends PBlocoExpressao
{
    private PExpressaoLogica _expressaoLogica_;

    public AExpressaoLogicaSimplesBlocoExpressao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressaoLogicaSimplesBlocoExpressao(
    ...
    {
        ((Analysis) sw).caseAExpressaoLogicaSimplesBlocoExpressao(this);
    }
