...
public final class ABlocoEspressoesLogicaBlocoExpressao extends PBlocoExpressao
{
    private PBlocoExpressao _blocoExpressao_;
    private TVirgula _virgula_;
    private PExpressaoLogica _expressaoLogica_;

    public ABlocoEspressoesLogicaBlocoExpressao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABlocoEspressoesLogicaBlocoExpressao(
    ...
    {
        ((Analysis) sw).caseABlocoEspressoesLogicaBlocoExpressao(this);
    }
