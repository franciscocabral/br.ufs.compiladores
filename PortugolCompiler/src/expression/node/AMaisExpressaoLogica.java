...
public final class AMaisExpressaoLogica extends PExpressaoLogica
{
    private PExpressaoLogica _l_;
    private PExpressaoLogica _r_;

    public AMaisExpressaoLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaisExpressaoLogica(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseAMaisExpressaoLogica(this);
    }
